...
namespace SqlSugar
{
    ...
    public class Queryable<T>
    {
        ...
        /// <returns></returns>
        public Queryable<T> JoinTable<T2, T3, T4>(Expression<Func<T, T2, T3, T4, object>> expression, JoinType type = JoinType.Left)
        {
            return this.JoinTable<T, T2, T3, T4>(expression, type);
        }
        /// <summary>
        /// 条件筛选
        /// </summary>
