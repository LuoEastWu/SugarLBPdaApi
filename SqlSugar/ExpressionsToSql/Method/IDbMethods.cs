...
namespace SqlSugar
{
    public interface IDbMethods
    {
        ...
        string IsNullToInt(MethodCallExpressionModel model);
        string IsNullToInt64(MethodCallExpressionModel model);
        string IsNullToEmpty(MethodCallExpressionModel model);
