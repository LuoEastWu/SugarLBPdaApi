...
namespace SqlSugar
{
    public partial class DefaultDbMethod : IDbMethods
    {
        ...
        public virtual string ToDateTime(MethodCallExpressionModel model)
        {
            ...
            var parameter2 = model.Args[1];
            return string.Format("Convert(varchar,{0},{1})", parameter1.MemberName, parameter2.MemberName);
        }

        public virtual string IsNullToEmpty(MethodCallExpressionModel model)
        {
            var parameter = model.Args[0];
