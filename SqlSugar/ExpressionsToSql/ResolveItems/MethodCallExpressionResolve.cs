...
namespace SqlSugar
{
    public class MethodCallExpressionResolve : BaseResolve
    {
        ...
        private object GetMdthodValue(string name, MethodCallExpressionModel model)
        {
            ...
            {
                case "ToDateTime":
                    return this.Context.DbMehtods.ToDateTime(model);
                case "IsNullToEmpty":
                    return this.Context.DbMehtods.IsNullToEmpty(model);
                case "IsNullToInt":
                    return this.Context.DbMehtods.IsNullToInt(model);
                case "IsNullToInt64":
                    return this.Context.DbMehtods.IsNullToInt64(model);
                case "IIF":
